package edu.hm.weidacher.softarch.shareit.exceptions;
...
public class ShareItException extends Exception {
     ...
     * @since 1.7
     */
    public ShareItException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
